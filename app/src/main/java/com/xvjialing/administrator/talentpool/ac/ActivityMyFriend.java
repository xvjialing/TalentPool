...
@EActivity
public class ActivityMyFriend extends AppCompatActivity {

    @ViewById(R.id.ac_myFriend_img_back)
    ImageView img_back;

    @ViewById(R.id.ac_myFriend_lv_friend)
    ListView lv_friend;

    private ArrayList<FriendInfo> friendList;
    private FriendListAdapter friendListAdapter;
    private String userId,friendId;
    private Context mContext=ActivityMyFriend.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ac_my_friend);
    }

    @Click(R.id.ac_myFriend_img_back)
    public void back(){
        finish();
    }
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                for(int i=0;i<jsonArray.length();i++){
                    ...
                    if (!TextUtils.equals(list_status,"0")){
