...
@EActivity
public class  ActivityResumeBasicInfo extends AppCompatActivity {

    @ViewById(R.id.ac_resume_basicInfo_sp_workLength)
    Spinner spinner_workLength;
    @ViewById(R.id.ac_resume_basicInfo_sp_rencentStatus)
    Spinner spinner_rencentStatus;
    @ViewById(R.id.ac_resume_basicInfo_tv_location1)
    TextView tv_location;
    @ViewById(R.id.ac_resume_basicInfo_et_name)
    EditText et_name;
    @ViewById(R.id.ac_resume_basicInfo_rg_sex)
    RadioGroup rg_sex;
    @ViewById(R.id.ac_resume_basicInfo_rb_male)
    RadioButton rb_male;
    @ViewById(R.id.ac_resume_basicInfo_rb_female)
    RadioButton rb_female;
    @ViewById(R.id.ac_resume_basicInfo_img_back)
    ImageView img_back;
    @ViewById(R.id.ac_resume_basicInfo_et_phoneNumber)
    EditText et_phoneNumber;
    @ViewById(R.id.ac_resume_basicInfo_btn_submit)
    Button btn_submit;
    @ViewById(R.id.ac_resume_basicInfo_ll_whole)
    LinearLayout ll_whole;
    OptionsPickerView pvOptions;
    private static final String url_add = AppHttp.Url_IP + "opensns/index.php?s=/Home/rencai/jiben";
    private static final String url_edit = AppHttp.Url_IP + "opensns/index.php?s=/Home/rencai/updatejiben";
    private ArrayList<ProvinceBean> options1Items = new ArrayList<ProvinceBean>();
    private ArrayList<ArrayList<String>> options2Items = new ArrayList<ArrayList<String>>();
    private ArrayList<ArrayList<ArrayList<String>>> options3Items = new ArrayList<ArrayList<ArrayList<String>>>();
    private Context mContext=ActivityResumeBasicInfo.this;
    ...
    private String str_workLength="2-3年";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ac_resume_basic_info);
    }
...
//        pwOptions.setLabels("省", "市", "区");
            ...
            public void onOptionsSelect(int options1, int option2, int options3) {
                ...
                if (TextUtils.equals(options1Items.get(options1).getPickerViewText(), "上海")) {
                    ...
                    str_location = options1Items.get(options1).getPickerViewText() + "省"
                            ...
                            + options3Items.get(options1).get(option2).get(options3);
                    //SharedPreferencesUtils.setParam(mContext,"basicInfoLocatn",str_location);
                }
    ...
    //返回按钮
    @Click(R.id.ac_resume_basicInfo_img_back)
    public void back(){
        if (TextUtils.equals(SharedPreferencesUtils.getParam(mContext, "basicInfoTag","0").toString(), "0")) {
            startActivity(new Intent(mContext, ActivityResumeBasicInfo_.class));
    ...
    //提交
    @Click(R.id.ac_resume_basicInfo_btn_submit)
    public void clickSubmit(){
        if (TextUtils.equals("", et_name.getText().toString().trim())) {
            ...
            userId = SharedPreferencesUtils.getParam(ActivityResumeBasicInfo.this, "userId", "") + "";
    ...
    //选择地址
    @Click(R.id.ac_resume_basicInfo_tv_location1)
    ...
    public void initWorkList(){
        ...
        spinner_workLength.setAdapter(adapter);

        spinner_workLength.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
    ...
    public void initWorkStatusList(){
        ...
        spinner_rencentStatus.setAdapter(adapter2);

        spinner_rencentStatus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
